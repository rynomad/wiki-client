...
resolve.resolveLinks = (string) ->
  ...
  string
    ...
    .replace(/\[((http|https|ftp):.*?) (.*?)\]/gi, """<a class="external" target="_blank" href="$1" title="$1" rel="nofollow">$3 <img class="external" src="chrome-extension://#{chrome.i18n.getmessage( '@@extension_id' )}/images/external-link-ltr-icon.png"></a>""")
